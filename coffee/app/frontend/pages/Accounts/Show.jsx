  ...
  return (
    <>
      ...
      <NativeNavbar title="Account">
        <NativeButton icon="ellipsis.circle" icons={{ ios: "ellipsis.circle", android: "more_vert" }}>
          <NativeMenuItem title="Edit profile" href="/account/edit" icon="pencil" icons={{ ios: "pencil", android: "edit" }} />
          <NativeMenuItem title="Sign out" click="#sign-out" icon="rectangle.portrait.and.arrow.right" icons={{ ios: "rectangle.portrait.and.arrow.right", android: "logout" }} />
        </NativeButton>
      </NativeNavbar>
